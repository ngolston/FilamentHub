...
const schema = z.object({
  ...
  extra_color_hex_2: z.string().optional(),
  extra_color_hex_3: z.string().optional(),
  extra_color_hex_4: z.string().optional(),
...
export default function EditSpoolPage() {
  ...
  useEffect(() => {
    ...
    reset({
      ...
      material:       spool.material ?? spool.filament?.material ?? '',
